...
MODEL                = mbd3
MODULES              = rt_logging.c mbd3.c mbd3_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/mbd3.exe
MAKEFILE             = mbd3.mk
MATLAB_ROOT          = C:/Program Files/Polyspace/R2021a
ALT_MATLAB_ROOT      = C:/PROGRA~1/POLYSP~1/R2021a
START_DIR            = C:/Users/Shereen/Documents/Matlab_tasks/MBD3
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = mbd3_ref.rsp
